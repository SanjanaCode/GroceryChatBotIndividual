...
class Bot:
    ...
    def start_conversation(self):
        ...
        while True:
            ...
            if(intent == "Default Welcome Intent" or intent == "product-info"):
            ...
            # pass to product-info in route_to_handle. 
            # Set the undetected intent count to 0
            elif(intent == "product-price" or intent == "product-stock" or intent == "product-nutrition"):
                productName = response.parameters["product-name"]
                print("json object")
                print("{")
                print(response)
                print("}")
                print("Bot: " + self.route_to_handler(productName = productName, intent = intent, user_input = user_input))
                self.undetected_intent_count = 0
